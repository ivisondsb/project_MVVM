...
import com.ivisondsb.projectmvvm.R
import com.ivisondsb.projectmvvm.databinding.ResItemLiveBinding
import com.ivisondsb.projectmvvm.models.Lives

class MainAdapter(private val onItemClicked: (Lives) -> Unit) :
    RecyclerView.Adapter<MainViewHolder>() {

    private var lives = mutableListOf<Lives>()

    fun setMovieList(movies: List<Lives>) {
...
class MainViewHolder(val binding: ResItemLiveBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    fun bind(live: Lives, onItemClicked: (Lives) -> Unit) {
